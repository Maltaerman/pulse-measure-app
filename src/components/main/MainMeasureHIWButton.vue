...
<template>
  <button
    type="button"
    class="group flex flex-row items-center justify-center z-10 cursor-pointer"
  ...
  >
    ...
    <BaseIcon name="info" class="size-5 text-text-primary transition-all duration-300" />
  </button>
</template>
