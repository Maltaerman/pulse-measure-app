...
<template>
  <section class="flex-1 flex flex-col items-center justify-center">
    ...
    >
      <div class="absolute w-48 h-48 bg-primary/10 rounded-full animate-ping [animation-delay:100ms]" />
      <div class="absolute w-36 h-36 bg-primary/20 rounded-full animate-ping [animation-delay:500ms]" />
      <div class="absolute w-28 h-28 bg-primary/30 rounded-full animate-ping [animation-delay:900ms]" />
      ...
      <p
        class="text-text-secondary uppercase"
        v-text="'bpm'"
      />
    </button>
