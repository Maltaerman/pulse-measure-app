...
<template>
  <section>
    ...
    >
      ...
      <div class="flex items-center justify-between py-2">
        <span class="text-sm" v-text="'Reminder Time'" />
      ...
      <div class="flex items-center justify-between py-2">
        <span class="text-sm" v-text="'Vibration'" />

        <BaseToggle v-model="state.vibration" />
      </div>

      <div class="pt-2">
        <p class="text-xs text-text-secondary mb-2">Heart Rate Zones</p>
      ...
      <div class="flex items-center justify-between py-2">
        <span class="text-sm" v-text="'Show in Apple Health'" />
      ...
      <div class="flex items-center justify-between py-2" @click="toggleTheme">
        ...
        <BaseToggle :model-value="theme === THEME_ENUM.DARK" @update:model-value="toggleTheme" />
      </div>
    </div>
  </section>
</template>
